    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      <div className="relative w-[390px] h-[844px] bg-white rounded-xl shadow-lg overflow-hidden z-10">
        ...
        <button
          ...
          className={`absolute top-[118px] right-6 rounded-full bg-orange-500 text-white text-[13px] font-bold px-3 py-1.5 shadow-lg transition-all duration-300 hover:bg-orange-600 ${
